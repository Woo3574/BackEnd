...
from bs4 import BeautifulSoup # 파싱을 위해서 사용
...
def get_sample_weather():
    ...
    for loc in soup.select("location"):
        ...
        html_output += f"<h4>최저 / 최고 기온 : {loc.select_one('tmn')}/{loc.select_one('tmx')}</h4><hr>"
        html_output += "</hr>"
    return html_output

def get_short_term_weather():
    API_KEY = "mI%2BgyKRhNvjqLz9%2Bbo4rklluEgYZtCzT2QdnmAhTi0JUpH1FRU8LlRW1euS6dasdu7n5nPqf7AhevJCDH6G21g%3D%3D"
